...
class _$Login200Response extends Login200Response {
  ...
  _$Login200Response._({this.code, this.data, this.msg}) : super._();
...
class Login200ResponseBuilder
    implements
        Builder<Login200Response, Login200ResponseBuilder>,
  ...
  @override
  void replace(covariant Login200Response other) {
  ...
  _$Login200Response _build() {
    final _$result =
        _$v ?? new _$Login200Response._(code: code, data: data, msg: msg);
    replace(_$result);
    return _$result;
  }
}
