...
class UserApi {
  ...
  Future<Response<ChangePassword200Response>> changePassword({ 
    required TypesChangePasswordRequest body,
    ...
    final _path = r'/account/user/v1/users/change-password';
    ...
    try {
      const _type = FullType(TypesChangePasswordRequest);
  ...
  Future<Response<Me200Response>> me({ 
    ...
    final _path = r'/account/user/v1/users/me';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UpdateProfile200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UpdateProfile200Response>> updateProfile({ 
    required TypesUpdateProfileRequest body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/account/user/v1/users/profile';
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(TypesUpdateProfileRequest);
      _bodyData = _serializers.serialize(body, specifiedType: _type);
    ...
    UpdateProfile200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(UpdateProfile200Response),
      ) as UpdateProfile200Response;
    ...
    return Response<UpdateProfile200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
