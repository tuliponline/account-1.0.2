...
import 'package:edupluz_account/src/api_util.dart';
...
class AuthApi {
  ...
  Future<Response<ForgotPassword200Response>> forgotPassword({ 
    required TypesForgotPasswordRequest body,
    ...
    final _path = r'/account/auth/v1/auth/forgot-password';
    ...
    try {
      const _type = FullType(TypesForgotPasswordRequest);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetIdp200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetIdp200Response>> getIdp({ 
    String? provider,
    String? redirectUri,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/account/auth/v1/auth/idp';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    GetIdp200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetIdp200Response),
      ) as GetIdp200Response;
    ...
    return Response<GetIdp200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetToken200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetToken200Response>> getToken({ 
    String? clientSecret,
    String? code,
    String? codeVerifier,
    String? grantType,
    ...
    final _path = r'/account/auth/v1/auth/token';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (codeVerifier != null) r'code_verifier': encodeQueryParameter(_serializers, codeVerifier, const FullType(String)),
    ...
    GetToken200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetToken200Response),
    ...
    return Response<GetToken200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<Login200Response>> login({ 
    required TypesLoginRequest body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/account/auth/v1/auth/login';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(TypesLoginRequest);
      _bodyData = _serializers.serialize(body, specifiedType: _type);
  ...
  Future<Response<Register200Response>> register({ 
    required TypesRegisterRequest body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/account/auth/v1/auth/register';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(TypesRegisterRequest);
      _bodyData = _serializers.serialize(body, specifiedType: _type);
  ...
  Future<Response<ResetPassword200Response>> resetPassword({ 
    required TypesResetPasswordRequest body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/account/auth/v1/auth/reset-password';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(TypesResetPasswordRequest);
      _bodyData = _serializers.serialize(body, specifiedType: _type);
